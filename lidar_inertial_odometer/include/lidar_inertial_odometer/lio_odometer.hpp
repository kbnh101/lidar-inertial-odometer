 ...
 *                                     initial_guess
 *                                          v
 *   LiDAR 10 Hz --> deskew --> FeatureExtractor --> IcpFusedPointPlane(local map)
 *                                          |
 *                                       T_icp --> state update
 *
...
public:
     ...
     */
    fused_icp::IcpFusedPointPlane& icp()
    {
        return icp_;
    }
...
private:
    ...
    fused_icp::IcpFusedPointPlane icp_;  ///< the fused-point-plane-icp implementation, reused as is
    LocalMap local_map_;
