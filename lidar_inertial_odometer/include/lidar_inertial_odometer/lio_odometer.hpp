 ...
 *                                     initial_guess
 *                                          v
 *   LiDAR 10 Hz --> deskew --> FeatureExtractor --> IcpPointToPointPlane(local map)
 *                                          |
 *                                       T_icp --> state update
 *
...
public:
     ...
     */
    p2ptpl_icp::IcpPointToPointPlane& icp()
    {
        return icp_;
    }
...
private:
    ...
    p2ptpl_icp::IcpPointToPointPlane icp_;  ///< the point-to-plane-icp implementation, reused as is
    LocalMap local_map_;
